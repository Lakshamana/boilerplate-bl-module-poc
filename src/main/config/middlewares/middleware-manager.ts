import { MiddlewareErrorHandlerInterface } from './errors-handlers'
import { MiddlewareInterface } from './middleware-interface'
import { MiddlewareManagerInterface } from '@/main/config/middlewares/middleware-manager-interface'

export class MiddlewareManager<T, R> implements MiddlewareManagerInterface<T, R> {
